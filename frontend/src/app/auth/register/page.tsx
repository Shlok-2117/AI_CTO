      ...
      {showGoogleModal && (
        ...
        >
          <motion.div
            ...
            className="hud-panel hud-corners rounded-xl p-8 max-w-sm w-full text-center"
          ...
          >
            ...
            <h3 className="font-black text-lg mb-2" style={{color: '#F8FAFC'}}>Google Sign In</h3>
            <div className="text-[10px] font-mono tracking-widest mb-4" style={{color: 'rgba(0,212,255,0.5)'}}>
              COMING SOON
            </div>
            <p className="text-sm mb-6" style={{color: 'rgba(248,250,252,0.3)'}}>
              Google OAuth is currently in development. Please use email and password to create your account.
            </p>
            <button onClick={() => setShowGoogleModal(false)} className="btn-jarvis w-full justify-center">
              USE EMAIL INSTEAD
            </button>
          </motion.div>
        </div>
