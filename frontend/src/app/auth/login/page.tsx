...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const messages: Record<string, string> = {
      google_not_configured: 'Google Sign In is not yet enabled on this server.',
      google_failed: 'Google authentication failed. Please try again or use email login.',
      google_cancelled: 'Google sign-in was cancelled.',
    }
    setError(messages[oauthError] || 'Google authentication error. Please use email login.')
